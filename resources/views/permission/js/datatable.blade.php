<script type="text/javascript">
    let baseUrl = "{{ route('permission.index') }}";
    let createUrl = "{{ route('permission.create') }}";
        ...
        $('#permissionDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('permission.show', 'data-id') }}";                    
                    let editUrl = "{{ route('permission.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('permission.destroy', 'data-id') }}";
