<script type="text/javascript">
    let baseUrl = "{{ route('process.index') }}";
    let createUrl = "{{ route('process.create') }}";
        ...
        $('#processDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('process.show', 'data-id') }}";                    
                    let editUrl = "{{ route('process.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('process.destroy', 'data-id') }}";
