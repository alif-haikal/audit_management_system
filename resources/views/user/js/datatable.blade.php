<script type="text/javascript">
    let baseUrl = "{{ route('user.index') }}";
    let createUrl = "{{ route('user.create') }}";
        ...
        $('#userDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('user.show', 'data-id') }}";
                    let editUrl = "{{ route('user.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('user.destroy', 'data-id') }}";
