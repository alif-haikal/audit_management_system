<script type="text/javascript">
    let baseUrl = "{{ route('activity.index') }}";
    let createUrl = "{{ route('activity.create') }}";
        ...
        $('#activityDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('activity.show', 'data-id') }}";                    
                    let editUrl = "{{ route('activity.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('activity.destroy', 'data-id') }}";
