<script type="text/javascript">
    let baseUrl = "{{ route('role.index') }}";
    let createUrl = "{{ route('role.create') }}";
        ...
        $('#roleDatatable').DataTable({
            ...
            columnDefs: [{
                ...
                "render": function(id, type, full, meta) {
                    let showUrl = "{{ route('role.show', 'data-id') }}";                    
                    let editUrl = "{{ route('role.edit', 'data-id') }}";
                    let deleteUrl = "{{ route('role.destroy', 'data-id') }}";
